    ...
    if (kUseMockServices) {
      ...
      final dummyProducts = <Product>[
        const Product(
          ...
          descripcion: "Zapatillas ligeras para entrenar o salir a correr.",
          categoria: "Calzado",
          precio: 59.99,
          imagenUrl: "https://picsum.photos/seed/zapatos/600/400",
          stock: 10,
        ),
        const Product(
          nombre: "Camiseta básica",
          descripcion: "Camiseta de algodón suave disponible en varios colores.",
          categoria: "Ropa",
          precio: 19.99,
          imagenUrl: "https://picsum.photos/seed/camiseta/600/400",
          stock: 20,
        ),
        const Product(
          nombre: "Pantalón de mezclilla",
          descripcion: "Jeans clásicos corte recto con acabado resistente.",
          categoria: "Ropa",
          precio: 39.99,
          imagenUrl: "https://picsum.photos/seed/pantalon/600/400",
          stock: 15,
        ),
      ];
